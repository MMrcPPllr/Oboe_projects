...
%%%                                                                                                           
%                                                                                                                                                                               
sim_n_1                      = load('Lab3_NEW\rpc_sim.mat');
sim_n_2                     = load('Lab3_NEW\rpc_ex.mat');
...
plot_simulation100=('.rpc_1H_0_1K');                              
plot_simulation101=('.rpc_1H_0_8K');              
plot_simulation102=('.rpc_1H_2K');    
plot_simulation103=('.rpc_1H_0_8K_pseudo');   
plot_simulation104=('.rpc_450sample');   
plot_simulation105=('.rpc_50sampledelay');   
plot_simulation106=('.rpc_4H');   

plot_simulation200=('.q_rpc_0_8_stima');
plot_simulation201=('.q_rpc_0_8_pseudo');
plot_simulation202=('.q_rpc_0_8_5Hz_pseudo');
...
% scelto sopra
plot_simulation_n_1_num   = '202';                                    
plot_simulation_n_2_num   = '202';    
