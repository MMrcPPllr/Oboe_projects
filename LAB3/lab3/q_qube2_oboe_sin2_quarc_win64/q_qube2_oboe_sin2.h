...
#ifndef RTW_HEADER_q_qube2_oboe_sin2_h_
#define RTW_HEADER_q_qube2_oboe_sin2_h_
#include <math.h>
#include <string.h>
#ifndef q_qube2_oboe_sin2_COMMON_INCLUDES_
#define q_qube2_oboe_sin2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* q_qube2_oboe_sin2_COMMON_INCLUDES_ */

#include "q_qube2_oboe_sin2_types.h"
...
#define q_qube2_oboe_sin2_rtModel      RT_MODEL_q_qube2_oboe_sin2_T

/* Block signals (default storage) */
typedef struct {
  real_T HILReadEncoderTimebase;       /* '<Root>/HIL Read Encoder Timebase' */
  real_T riferimento_theta;            /* '<Root>/Sine Wave' */
  real_T riferimento_theta_dot;        /* '<Root>/Sine Wave1' */
...
} DW_q_qube2_oboe_sin2_T;

/* Continuous states (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} X_q_qube2_oboe_sin2_T;

/* State derivatives (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_q_qube2_oboe_sin2_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_q_qube2_oboe_sin2_T;
...
#define rtB                            q_qube2_oboe_sin2_B
#define BlockIO                        B_q_qube2_oboe_sin2_T
#define rtX                            q_qube2_oboe_sin2_X
#define ContinuousStates               X_q_qube2_oboe_sin2_T
#define rtXdot                         q_qube2_oboe_sin2_XDot
#define StateDerivatives               XDot_q_qube2_oboe_sin2_T
#define tXdis                          q_qube2_oboe_sin2_XDis
#define StateDisabled                  XDis_q_qube2_oboe_sin2_T
#define rtP                            q_qube2_oboe_sin2_P
#define Parameters                     P_q_qube2_oboe_sin2_T
#define rtDWork                        q_qube2_oboe_sin2_DW
#define D_Work                         DW_q_qube2_oboe_sin2_T

/* Parameters (default storage) */
struct P_q_qube2_oboe_sin2_T_ {
...
struct tag_RTM_q_qube2_oboe_sin2_T {
  const char_T *path;
...
extern P_q_qube2_oboe_sin2_T q_qube2_oboe_sin2_P;

/* Block signals (default storage) */
extern B_q_qube2_oboe_sin2_T q_qube2_oboe_sin2_B;

/* Continuous states (default storage) */
extern X_q_qube2_oboe_sin2_T q_qube2_oboe_sin2_X;

/* Block states (default storage) */
extern DW_q_qube2_oboe_sin2_T q_qube2_oboe_sin2_DW;

/* Model entry point functions */
extern void q_qube2_oboe_sin2_initialize(void);
extern void q_qube2_oboe_sin2_output(void);
extern void q_qube2_oboe_sin2_update(void);
extern void q_qube2_oboe_sin2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_qube2_oboe_sin2_rtModel *q_qube2_oboe_sin2(void);
...
extern RT_MODEL_q_qube2_oboe_sin2_T *const q_qube2_oboe_sin2_M;
 ...
 *
 * '<Root>' : 'q_qube2_oboe_sin2'
 */
#endif                                 /* RTW_HEADER_q_qube2_oboe_sin2_h_ */
