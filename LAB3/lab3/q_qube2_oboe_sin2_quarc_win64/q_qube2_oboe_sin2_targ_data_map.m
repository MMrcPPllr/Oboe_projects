  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (q_qube2_oboe_sin2_P)
    ;%
      section.nData     = 3;
      section.data(3)  = dumData; %prealloc
      
	  ;% q_qube2_oboe_sin2_P.Festar1
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_P.Gestar1
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 9;
	
	  ;% q_qube2_oboe_sin2_P.KK
	  ...
	  ;% q_qube2_oboe_sin2_P.HILWriteAnalog_channels
	  section.data(1).logicalSrcIdx = 3;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_P.HILReadAnalog_channels
	  ...
	  ;% q_qube2_oboe_sin2_P.HILInitialize_OOTerminate
	  section.data(2).logicalSrcIdx = 6;
	  section.data(2).dtTransOffset = 1;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_OOExit
	  section.data(3).logicalSrcIdx = 7;
	  section.data(3).dtTransOffset = 2;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_OOStart
	  section.data(4).logicalSrcIdx = 8;
	  section.data(4).dtTransOffset = 3;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_OOEnter
	  ...
	  ;% q_qube2_oboe_sin2_P.HILInitialize_CKChannels
	  section.data(1).logicalSrcIdx = 43;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOWatchdog
	  ...
	  ;% q_qube2_oboe_sin2_P.HILReadEncoderTimebase_Clock
	  ...
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AIChannels
	  ...
	  ;% q_qube2_oboe_sin2_P.HILInitialize_EIChannels
	  ...
	  ;% q_qube2_oboe_sin2_P.HILReadEncoderTimebase_Channels
	  ...
	  ;% q_qube2_oboe_sin2_P.HILInitialize_Active
	  section.data(1).logicalSrcIdx = 55;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AOTerminate
	  section.data(2).logicalSrcIdx = 56;
	  section.data(2).dtTransOffset = 1;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AOExit
	  section.data(3).logicalSrcIdx = 57;
	  section.data(3).dtTransOffset = 2;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOTerminate
	  section.data(4).logicalSrcIdx = 58;
	  section.data(4).dtTransOffset = 3;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOExit
	  section.data(5).logicalSrcIdx = 59;
	  section.data(5).dtTransOffset = 4;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_POTerminate
	  section.data(6).logicalSrcIdx = 60;
	  section.data(6).dtTransOffset = 5;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_POExit
	  section.data(7).logicalSrcIdx = 61;
	  section.data(7).dtTransOffset = 6;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_CKPStart
	  section.data(8).logicalSrcIdx = 62;
	  section.data(8).dtTransOffset = 7;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_CKPEnter
	  section.data(9).logicalSrcIdx = 63;
	  section.data(9).dtTransOffset = 8;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_CKStart
	  section.data(10).logicalSrcIdx = 64;
	  section.data(10).dtTransOffset = 9;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_CKEnter
	  section.data(11).logicalSrcIdx = 65;
	  section.data(11).dtTransOffset = 10;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AIPStart
	  section.data(12).logicalSrcIdx = 66;
	  section.data(12).dtTransOffset = 11;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AIPEnter
	  section.data(13).logicalSrcIdx = 67;
	  section.data(13).dtTransOffset = 12;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AOPStart
	  section.data(14).logicalSrcIdx = 68;
	  section.data(14).dtTransOffset = 13;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AOPEnter
	  section.data(15).logicalSrcIdx = 69;
	  section.data(15).dtTransOffset = 14;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AOStart
	  section.data(16).logicalSrcIdx = 70;
	  section.data(16).dtTransOffset = 15;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AOEnter
	  section.data(17).logicalSrcIdx = 71;
	  section.data(17).dtTransOffset = 16;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_AOReset
	  section.data(18).logicalSrcIdx = 72;
	  section.data(18).dtTransOffset = 17;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOPStart
	  section.data(19).logicalSrcIdx = 73;
	  section.data(19).dtTransOffset = 18;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOPEnter
	  section.data(20).logicalSrcIdx = 74;
	  section.data(20).dtTransOffset = 19;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOStart
	  section.data(21).logicalSrcIdx = 75;
	  section.data(21).dtTransOffset = 20;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOEnter
	  section.data(22).logicalSrcIdx = 76;
	  section.data(22).dtTransOffset = 21;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_DOReset
	  section.data(23).logicalSrcIdx = 77;
	  section.data(23).dtTransOffset = 22;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_EIPStart
	  section.data(24).logicalSrcIdx = 78;
	  section.data(24).dtTransOffset = 23;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_EIPEnter
	  section.data(25).logicalSrcIdx = 79;
	  section.data(25).dtTransOffset = 24;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_EIStart
	  section.data(26).logicalSrcIdx = 80;
	  section.data(26).dtTransOffset = 25;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_EIEnter
	  section.data(27).logicalSrcIdx = 81;
	  section.data(27).dtTransOffset = 26;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_POPStart
	  section.data(28).logicalSrcIdx = 82;
	  section.data(28).dtTransOffset = 27;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_POPEnter
	  section.data(29).logicalSrcIdx = 83;
	  section.data(29).dtTransOffset = 28;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_POStart
	  section.data(30).logicalSrcIdx = 84;
	  section.data(30).dtTransOffset = 29;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_POEnter
	  section.data(31).logicalSrcIdx = 85;
	  section.data(31).dtTransOffset = 30;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_POReset
	  section.data(32).logicalSrcIdx = 86;
	  section.data(32).dtTransOffset = 31;
	
	  ;% q_qube2_oboe_sin2_P.HILInitialize_OOReset
	  ...
	  ;% q_qube2_oboe_sin2_P.HILReadEncoderTimebase_Active
	  section.data(36).logicalSrcIdx = 90;
	  section.data(36).dtTransOffset = 35;
	
	  ;% q_qube2_oboe_sin2_P.HILWriteAnalog_Active
	  section.data(37).logicalSrcIdx = 91;
	  section.data(37).dtTransOffset = 36;
	
	  ;% q_qube2_oboe_sin2_P.HILReadAnalog_Active
	  ...
	  ;% q_qube2_oboe_sin2_P.HILReadEncoderTimebase_Overflow
	  section.data(1).logicalSrcIdx = 93;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_P.ManualSwitch1_CurrentSetting
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% q_qube2_oboe_sin2_B.stato_stimato_con_x3
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	
	  ;% q_qube2_oboe_sin2_B.MultiportSwitch
	  ...
	  ;% q_qube2_oboe_sin2_B.TmpSignalConversionAtToWorkspac
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (q_qube2_oboe_sin2_DW)
    ;%
      section.nData     = 3;
      section.data(3)  = dumData; %prealloc
      
	  ;% q_qube2_oboe_sin2_DW.DiscreteStateSpace1_DSTATE
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_DW.HILInitialize_FilterFrequency
	  section.data(2).logicalSrcIdx = 1;
	  ...
	  ;% q_qube2_oboe_sin2_DW.HILWriteAnalog_PWORK
	  section.data(1).logicalSrcIdx = 5;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_DW.Scope_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 6;
	  section.data(2).dtTransOffset = 1;
	
	  ;% q_qube2_oboe_sin2_DW.Scope1_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 7;
	  section.data(3).dtTransOffset = 2;
	
	  ;% q_qube2_oboe_sin2_DW.Scope2_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 8;
	  section.data(4).dtTransOffset = 3;
	
	  ;% q_qube2_oboe_sin2_DW.Scope3_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 9;
	  section.data(5).dtTransOffset = 4;
	
	  ;% q_qube2_oboe_sin2_DW.Scope4_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 10;
	  section.data(6).dtTransOffset = 5;
	
	  ;% q_qube2_oboe_sin2_DW.Scope5_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 11;
	  section.data(7).dtTransOffset = 6;
	
	  ;% q_qube2_oboe_sin2_DW.ToWorkspace_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 12;
	  section.data(8).dtTransOffset = 8;
	
	  ;% q_qube2_oboe_sin2_DW.HILReadAnalog_PWORK
	  section.data(9).logicalSrcIdx = 13;
	  section.data(9).dtTransOffset = 9;
	
	  ;% q_qube2_oboe_sin2_DW.Motorcurrent_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 14;
	  ...
	  ;% q_qube2_oboe_sin2_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 15;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_qube2_oboe_sin2_DW.HILInitialize_DOStates
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% q_qube2_oboe_sin2_DW.HILInitialize_QuadratureModes
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% q_qube2_oboe_sin2_DW.HILInitialize_InitialEICounts
