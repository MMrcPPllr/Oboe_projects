/*
 * q_qube2_oboe_lqr1_zptec_data.c
 *
...
P_q_qube2_oboe_lqr1_zptec_T q_qube2_oboe_lqr1_zptec_P = {
  /* Variable: Festar
   ...
   */
  { 0.013420970408226049, -0.010218046891784254, -0.012903591570096278,
    0.01041632072060278 },

  /* Expression: (n(2)*2)^2
   * Referenced by: '<Root>/Discrete Filter1'
   */
  0.00071083300474808031,
