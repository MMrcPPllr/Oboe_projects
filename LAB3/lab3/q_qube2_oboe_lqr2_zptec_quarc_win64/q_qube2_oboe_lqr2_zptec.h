...
#ifndef RTW_HEADER_q_qube2_oboe_lqr2_zptec_h_
#define RTW_HEADER_q_qube2_oboe_lqr2_zptec_h_
#include <math.h>
#include <string.h>
#ifndef q_qube2_oboe_lqr2_zptec_COMMON_INCLUDES_
#define q_qube2_oboe_lqr2_zptec_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                            /* q_qube2_oboe_lqr2_zptec_COMMON_INCLUDES_ */

#include "q_qube2_oboe_lqr2_zptec_types.h"
...
#define q_qube2_oboe_lqr2_zptec_rtModel RT_MODEL_q_qube2_oboe_lqr2_zp_T
...
typedef struct {
  ...
  real_T riferimento_theta_dot;        /* '<Root>/Constant1' */
  real_T uscita;                       /* '<Root>/Counts to rad' */
  real_T TransferFcn;                  /* '<Root>/Transfer Fcn' */
  real_T stato_stimato[3];             /* '<Root>/Discrete State-Space1' */
  ...
  real_T comandodopocompensazione;     /* '<Root>/Subtract2' */
  real_T Saturation1;                  /* '<Root>/Saturation1' */
  real_T Step1;                        /* '<Root>/Step1' */
  real_T Subtract1;                    /* '<Root>/Subtract1' */
  real_T u0VLimit;                     /* '<Root>/+//- 10V Limit' */
  real_T riferimento_theta_zm2;        /* '<Root>/Delay1' */
  real_T errore_rif_e_zm2;             /* '<Root>/Subtract3' */
...
} B_q_qube2_oboe_lqr2_zptec_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T DiscreteFilter1_states[3];    /* '<Root>/Discrete Filter1' */
  real_T DiscreteStateSpace1_DSTATE[3];/* '<Root>/Discrete State-Space1' */
  ...
  struct {
    void *LoggedData;
  } Motorcurrent_PWORK;                /* '<Root>/Motor current' */
  ...
  int32_T counter;                     /* '<Root>/Sine Wave2' */
} DW_q_qube2_oboe_lqr2_zptec_T;

/* Continuous states (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} X_q_qube2_oboe_lqr2_zptec_T;

/* State derivatives (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_q_qube2_oboe_lqr2_zptec_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_q_qube2_oboe_lqr2_zptec_T;
...
#define rtB                            q_qube2_oboe_lqr2_zptec_B
#define BlockIO                        B_q_qube2_oboe_lqr2_zptec_T
#define rtX                            q_qube2_oboe_lqr2_zptec_X
#define ContinuousStates               X_q_qube2_oboe_lqr2_zptec_T
#define rtXdot                         q_qube2_oboe_lqr2_zptec_XDot
#define StateDerivatives               XDot_q_qube2_oboe_lqr2_zptec_T
#define tXdis                          q_qube2_oboe_lqr2_zptec_XDis
#define StateDisabled                  XDis_q_qube2_oboe_lqr2_zptec_T
#define rtP                            q_qube2_oboe_lqr2_zptec_P
#define Parameters                     P_q_qube2_oboe_lqr2_zptec_T
#define rtDWork                        q_qube2_oboe_lqr2_zptec_DW
#define D_Work                         DW_q_qube2_oboe_lqr2_zptec_T

/* Parameters (default storage) */
struct P_q_qube2_oboe_lqr2_zptec_T_ {
  real_T Festar1[9];                   /* Variable: Festar1
                                        * Referenced by: '<Root>/Discrete State-Space1'
                                        */
  real_T Gestar1[6];                   /* Variable: Gestar1
                                        * Referenced by: '<Root>/Discrete State-Space1'
                                        */
  real_T KK[2];                        /* Variable: KK
  ...
  real_T SineWave2_Offset;             /* Expression: 0
                                        * Referenced by: '<Root>/Sine Wave2'
                                        */
  real_T DiscreteFilter1_NumCoef[4];   /* Expression: conv(d,n)
                                        * Referenced by: '<Root>/Discrete Filter1'
                                        */
  real_T DiscreteFilter1_DenCoef;      /* Expression: (n(2)*2)^2
                                        * Referenced by: '<Root>/Discrete Filter1'
                                        */
  ...
  real_T Constant1_Value;              /* Expression: 0
                                        ...
                                        */
  real_T upseudomisura2stima_Value;    /* Expression: 2
  ...
  real_T TransferFcn_D;                /* Computed Parameter: TransferFcn_D
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  real_T DiscreteStateSpace1_C[9];     /* Expression: eye(3)
                                        * Referenced by: '<Root>/Discrete State-Space1'
                                        */
  real_T DiscreteStateSpace1_D[6];     /* Expression: [0 0; 0 0 ; 0 0]
                                        * Referenced by: '<Root>/Discrete State-Space1'
                                        */
  real_T DiscreteStateSpace1_InitialCond[3];/* Expression: [0 0 0]'
                                             * Referenced by: '<Root>/Discrete State-Space1'
                                             */
...
struct tag_RTM_q_qube2_oboe_lqr2_zpt_T {
  const char_T *path;
...
extern P_q_qube2_oboe_lqr2_zptec_T q_qube2_oboe_lqr2_zptec_P;

/* Block signals (default storage) */
extern B_q_qube2_oboe_lqr2_zptec_T q_qube2_oboe_lqr2_zptec_B;

/* Continuous states (default storage) */
extern X_q_qube2_oboe_lqr2_zptec_T q_qube2_oboe_lqr2_zptec_X;

/* Block states (default storage) */
extern DW_q_qube2_oboe_lqr2_zptec_T q_qube2_oboe_lqr2_zptec_DW;

/* Model entry point functions */
extern void q_qube2_oboe_lqr2_zptec_initialize(void);
extern void q_qube2_oboe_lqr2_zptec_output(void);
extern void q_qube2_oboe_lqr2_zptec_update(void);
extern void q_qube2_oboe_lqr2_zptec_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_qube2_oboe_lqr2_zptec_rtModel *q_qube2_oboe_lqr2_zptec(void);
...
extern RT_MODEL_q_qube2_oboe_lqr2_zp_T *const q_qube2_oboe_lqr2_zptec_M;
 ...
 *
 * '<Root>' : 'q_qube2_oboe_lqr2_zptec'
 */
#endif                               /* RTW_HEADER_q_qube2_oboe_lqr2_zptec_h_ */
