  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (q_qube2_pd_P)
    ;%
      section.nData     = 1;
      section.data(1)  = dumData; %prealloc
      
	  ;% q_qube2_pd_P.HILWriteAnalog_channels
	  ...
	  ;% q_qube2_pd_P.HILInitialize_OOExit
	  section.data(2).logicalSrcIdx = 2;
	  section.data(2).dtTransOffset = 1;
	
	  ;% q_qube2_pd_P.HILInitialize_OOStart
	  section.data(3).logicalSrcIdx = 3;
	  section.data(3).dtTransOffset = 2;
	
	  ;% q_qube2_pd_P.HILInitialize_OOEnter
	  ...
	  ;% q_qube2_pd_P.HILInitialize_AIHigh
	  section.data(7).logicalSrcIdx = 7;
	  section.data(7).dtTransOffset = 8;
	
	  ;% q_qube2_pd_P.HILInitialize_AILow
	  section.data(8).logicalSrcIdx = 8;
	  section.data(8).dtTransOffset = 9;
	
	  ;% q_qube2_pd_P.HILInitialize_AOHigh
	  section.data(9).logicalSrcIdx = 9;
	  section.data(9).dtTransOffset = 10;
	
	  ;% q_qube2_pd_P.HILInitialize_AOLow
	  ...
	  ;% q_qube2_pd_P.HILInitialize_OOWatchdog
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% q_qube2_pd_DW.Scope_PWORK.LoggedData
  ...
  targMap.checksum0 = 1009681053;
  targMap.checksum1 = 1437484819;
  targMap.checksum2 = 2449370253;
  targMap.checksum3 = 2370620072;
