...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Colonne da cambiare     
graph_fig_1_caso_i_1_column = '7';  % x3 --> [V]        --> va convertito
graph_fig_1_caso_i_2_column = '12'; % è x3 o 0 in [V]   --> va convertito
graph_fig_1_caso_i_3_column = '12'; % è il disturbo di coppia 
graph_fig_1_caso_i_4_column = '1';
%%
graph_fig_2_caso_i_1_column = '7';
graph_fig_2_caso_i_2_column = '12';
...
graph_fig_3_title = 'Confronto tra riferimento e stima: variabile $\theta$ ';
graph_fig_4_title = 'Errore tra riferimento e stima: variabile $\theta$  ';
%%%
...
switch casi_da_confrontare 
    ...
    case 2
        ...
        plot(caso_n_time,caso_n_signal1-caso_n_signal2,...
            'LineWidth', 2);
        hold off
        set(gca,'TickLabelInterpreter',"latex",'FontSize',22)
        xlabel(graph_fig_4_time,'Interpreter',"latex",'FontSize',22) 
