%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% LOAD FILES
caso_simulato = load('simulazioni_prima_parte_parametri_nominali');
caso_quanser = load('quanser_parametri_variazione_NEW_NEW');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
caso      = 'caso';
casoSimulato = '_simulato';
casoQuanser  = '_quanser';
%%% caso_quanser.test_B_2.signals.values
% Da modificare in base al nome del file .mat salvato
plot_simulation = '.sistema_2x2_pseudo';
plot_simulation1 = '.quanser_3x3_stima_niente_compensazione';
%%%
plot_signal = '.signals';
plot_values   = '.values';
plot_time   = '.time';
