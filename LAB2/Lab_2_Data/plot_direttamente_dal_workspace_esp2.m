...
%%%
% Titoli delle figure
graph_1_title = 'Stima: $z$';
graph_2_title = 'Stima : ciao';
graph_3_title = 'Stima: $z$';
graph_4_title = 'Stima : ciao';
%%%
...
graph_2_simulato = strcat(graph_1_plot_name_variable,'{_{simulato}}$');
...
%                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
caso_n_time     = eval(strcat(caso,casoQuanser,plot_simulation,plot_time));
caso_n_signal   = eval(strcat(caso, casoQuanser,plot_simulation,plot_signal,plot_values,'(:,' ,signal_n_column,')'))*180/pi;
