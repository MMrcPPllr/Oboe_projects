...
grid on
hLine1=plot(caso14.simulazione_out.time,caso14.simulazione_out.signals.values(:,1),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'r');
hold on 
hLine=plot(caso15.simulazione_out.time,caso15.simulazione_out.signals.values(:,1),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'b');
...
legend('${{\theta}_{caso\, 14}}$','${{\theta}_{caso\, 15}}$','interpreter','latex','FontSize',22, 'Location','southwest')
...
% fontsize(gcf,scale=1.3)
grid on
hLine1=plot(caso14.simulazione_out.time,caso14.simulazione_out.signals.values(:,2),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'r');
hold on 
hLine=plot(caso15.simulazione_out.time,caso15.simulazione_out.signals.values(:,2),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'b');
...
legend('${{\alpha}_{caso\, 14}}$','${{\alpha}_{caso\, 15}}$','interpreter','latex','FontSize',22, 'Location','southwest')
fontsize(gca,scale=1.3)
xlim([0 15])
axis tight
...
% fontsize(gcf,scale=1.3)
grid on
hLine1=plot(caso14.simulazione_out.time,caso14.simulazione_out.signals.values(:,3),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'r');
hold on 
hLine=plot(caso15.simulazione_out.time,caso15.simulazione_out.signals.values(:,3),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'b');
...
legend('${\dot{\theta}_{caso\, 14}}$','${\dot{\theta}_{caso\, 15}}$','interpreter','latex','FontSize',22, 'Location','southwest')
fontsize(gca,scale=1.3)
xlim([0 15])
axis tight
...
% fontsize(gcf,scale=1.3)
grid on
hLine1=plot(caso14.simulazione_out.time,caso14.simulazione_out.signals.values(:,4),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'r');
hold on 
hLine=plot(caso15.simulazione_out.time,caso15.simulazione_out.signals.values(:,4),...
    'LineStyle','-',...
    'LineWidth',1.5,...
    'Color', 'b');
...
legend('${\dot{\alpha}_{caso\, 14}}$','${\dot{\alpha}_{caso\, 15}}$','interpreter','latex','FontSize',22, 'Location','southwest')
fontsize(gca,scale=1.3)
xlim([0 15])
axis tight
